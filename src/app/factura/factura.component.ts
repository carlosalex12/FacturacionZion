...
export class FacturaComponent implements OnInit {
  ...
  OnAddusuario(Factura: facturas): void {
    ...
    this.GlobalService
      .metodoPost('https://localhost:44381/Factura/Add?p_usr=' + this.gvariables.g_empid.id.id, {
  ...
  onUpdateArticulo(Factura: facturas): void {
    this.GlobalService
      .metodoPut('https://localhost:44381/Factura/Put?p_usr=' + this.gvariables.g_empid.id.id, {
        emp_cod: this.Factura.emp_cod,
        fac_num: this.Factura.fac_num,
        fac_fec: this.Factura.fac_fec,
        fac_est: this.Factura.fac_est,
