...
export class ClienteComponent implements OnInit {
  ...
  dataSource = new MatTableDataSource<articulo>(this.datatable);
  ...
  OnAddusuario(Cliente: clientes): void {
    ...
    this.GlobalService
      .metodoPost('https://localhost:44381/Cliente/Add?p_usr=' + this.gvariables.g_empid.id.id,
  ...
  onUpdateArticulo(cliente: clientes): void {
    this.GlobalService
      .metodoPut('https://localhost:44381/Cliente/Put?p_usr=' + this.gvariables.g_empid.id.id, {
  ...
  onDeleteArticulo(cliente: clientes): void {
    this.GlobalService
      .metodoPut('https://localhost:44381/Cliente/Delete?p_usr=' + this.gvariables.g_empid.id.id, {
        cli_cod: this.cliente.cli_cod,
      })
      .subscribe((resultado) => {
